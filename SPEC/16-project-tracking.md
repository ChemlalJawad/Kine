...
| P0-009 | Module Patients v1 | Kine Dev | Backend done, UI a cadrer | Branche feature/P0-009; API+domaine+tests verts; UI staff CRUD hors scope (pas de maquette SPEC) |
